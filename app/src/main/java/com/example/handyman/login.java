...
import com.example.handyman.CustomerDashboard;
import com.example.handyman.HandymanDashboard;
import com.example.handyman.register;
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        if(email.equals(confirmemail)){
                                            if(occupation.equals("Teacher")){
                                                startActivity(new Intent(login.this, HandymanDashboard.class).putExtra("activity","login"));//Go to the teachers home page once approved
                                            }else if(occupation.equals("Student")){
                                                startActivity(new Intent(login.this, CustomerDashboard.class));//Go the student homepage once validated
                                            }
                                        }else{
